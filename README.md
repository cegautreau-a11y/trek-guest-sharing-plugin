...
trek-guest-portal-2.0.4-complete-bundle.zip
```

- `trek-guest-portal-2.0.4.zip` — upload directly through **TREK → Admin → Plugins**.
- `trek-guest-portal-companion-2.0.4.zip` — extract on the Docker host and deploy with `docker compose`.
- `trek-guest-portal-2.0.4-complete-bundle.zip` — plugin, companion and repository documentation in one archive.
