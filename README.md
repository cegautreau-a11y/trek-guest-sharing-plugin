...
trek-guest-portal-3.5.0-complete-bundle.zip
```

- `trek-guest-portal-3.5.0.zip` — upload directly through **TREK → Admin → Plugins**.
- `trek-guest-portal-companion-3.5.0.zip` — extract on the Docker host and deploy with `docker compose`.
- `trek-guest-portal-3.5.0-complete-bundle.zip` — plugin, companion and repository documentation in one archive.
