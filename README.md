...
trek-guest-portal-2.0.3-complete-bundle.zip
```

- `trek-guest-portal-2.0.3.zip` — upload directly through **TREK → Admin → Plugins**.
- `trek-guest-portal-companion-2.0.3.zip` — extract on the Docker host and deploy with `docker compose`.
- `trek-guest-portal-2.0.3-complete-bundle.zip` — plugin, companion and repository documentation in one archive.
