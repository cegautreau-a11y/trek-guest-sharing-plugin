...
TREK Guest Portal v2.0.3 provides full operational logging for the guest-facing system without logging bearer share tokens, API keys, cookies, passwords, confirmation numbers, email addresses, or phone numbers.
