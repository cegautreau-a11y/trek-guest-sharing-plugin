...
This is the complete first-time installation procedure for TREK Guest Portal 2.1.1 using Docker Compose.
...
- `trek-guest-portal-2.1.1.zip` is uploaded directly to TREK. Do not unzip it first.
- `trek-guest-portal-companion-2.1.1.zip` is extracted on the Docker host.
...
3. Choose **Upload**.
4. Select `trek-guest-portal-2.1.1.zip`.
...
sudo unzip trek-guest-portal-companion-2.1.1.zip -d /opt/trek-guest-portal
